...
export  const DuoIcon = props => {
    if(props.name == "double-chevron-right"){
        return (
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    if(props.name == "calendar"){
        return (
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <g className="fa-group">
    ...
    if(props.name == "idcard"){
        return(
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <g className="fa-group">
    ...
    if(props.name == "finger"){
        return (
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                <g className="fa-group">
    ...
    if(props.name == "cancel"){
        return (
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352 512" >
                <g className="fa-group">
    ...
    if(props.name == "car-crash"){
        return (
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                <g className="fa-group">
    ...
    if(props.name == "chevron-right"){
        return (
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                <g className="fa-group">
    ...
    if(props.name == "double-chevron-left"){
        return (
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <g className="fa-group">
    ...
    if(props.name == "dice-d20"){
        return(
            <svg className={"svg "+(props.color!=null?props.color:"")} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512">
                <g className="fa-group">
    ...
    if(props.name == "dashboard"){
        return(
            <svg className={"svg "+(props.color!=null?props.color:"")} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <g className="fa-group">
